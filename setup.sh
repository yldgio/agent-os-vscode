...
BASE_URL="https://raw.githubusercontent.com/yldgio/agent-os-vscode/main"
...
echo "     curl -sSL https://raw.githubusercontent.com/yldgio/agent-os-vscode/main/setup-claude-code.sh | bash"
echo ""
echo "   - Using Cursor? Install the Cursor commands with:"
echo "     curl -sSL https://raw.githubusercontent.com/yldgio/agent-os-vscode/main/setup-cursor.sh | bash"
echo ""
